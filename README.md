...
6. [Scan pipeline (phases)](#scan-pipeline-phases)
7. [Findings: categories & severities](#findings-categories--severities)
8. [Health score](#health-score)
9. [Project configuration: `.security-checker.yml`](#project-configuration-security-checkeryml)
10. [Ignoring paths: `.security-checker-ignore`](#ignoring-paths-security-checker-ignore)
11. [False positives: `.security-checker-safe.yml`](#false-positives-security-checker-safeyml)
12. [Baseline: `.security-checker-baseline.json`](#baseline-security-checker-baselinejson)
13. [Custom rules: YAML](#custom-rules-yaml)
14. [Optional: OSV npm data](#optional-osv-npm-data)
15. [Optional: known-bad file hashes](#optional-known-bad-file-hashes)
16. [Optional: online npm audit](#optional-online-npm-audit)
17. [Exports & reports](#exports--reports)
18. [Application settings](#application-settings)
19. [Internationalization (TR / EN)](#internationalization-tr--en)
20. [Keyboard shortcuts](#keyboard-shortcuts)
21. [Privacy & network](#privacy--network)
22. [License](#license)
